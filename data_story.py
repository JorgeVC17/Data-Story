...
df = pd.read_csv("C:/Users/jorge/Documents/Anaconda files/malaria_reported_numbers.csv")

#Open de dataset van "Klimaat Verandering"
df1 = pd.read_csv("C:/Users/jorge/Documents/Anaconda files/climate_change_data.csv")

#Open de dataset van "Earth Surface Temperature:
df_k = pd.read_csv("C:/Users/jorge/Documents/Anaconda files/annual_csv.csv")
...
#Figure 1 en 2:
artikel1 = Image.open('C:/Users/jorge/Documents/Anaconda files/artikel1.jpg')
st.image(artikel1, caption="Figuur 1: Artikel over de invloed van klimaatverandering op Malaria")
malaria_image = Image.open('C:/Users/jorge/Documents/Anaconda files/malaria_parasiet.jpg')
...
stadion = Image.open('C:/Users/jorge/Documents/Anaconda files/stadion.jpg')
...
#Figuur 7:
tijgermug = Image.open('C:/Users/jorge/Documents/Anaconda files/tijgermug.jpg')
...
fig_klimaat1.update_xaxes(title_text='Country')
...
artikel2 = Image.open('C:/Users/jorge/Documents/Anaconda files/artikel2.jpg')
...
artikel3 = Image.open('C:/Users/jorge/Documents/Anaconda files/artikel3.jpg')
...
qrcode = Image.open('C:/Users/jorge/Documents/Anaconda files/qrcode.png')
st.image(qrcode)